...
=== 1. Issues im Kontext der Projektarbeit #TODO#

[#image_github_openup]
:imageTitle: GitHub Issues im Kontext der Projektarbeit
...
Folgend eine Variante der Abbildung mit den Möglichkeiten von Issues und Projects von GitHub (Siehe auch <<#image_github_openup>>):

====
.Abbildungsvariante in GitHub #TODO#
[cols="1,1,2"]
|===
| -      | GitHub    | Hinweise
...
* Es ist sinnvoll den Issues (Tasks) Asignees (Nutzer, Role) zuzuordnen, damit Klarheit über die Aufgabenzuteilung herrscht.
...
. Erstellen Sie in der *Overview* Sicht vier *Tasks* als neue Issues mit dem Label `task`, wovon sich die *zwei ersten* auf die vorhandene User Story beziehen sollen. Legen Sie sich jeweils als zugeordneter Nutzer fest. Schauen Sie sich Ihre *User Story* (Issue) an, ob die Referenzen aufgetaucht sind. Bspw.:
+
.Tasks
[cols="1,4,8"]
|===
