...
. Erstellen Sie ein neues Projekt *HTWD Beispielprojekt*.
...
. Blenden Sie in den Sichten, in denen keine Risiken erscheinen sollen, mit dem Filterzusatz `-label:risk` Issues mit dem Label `risk` aus.
** bspw.: Overview, Current Iteration, Current & Next Iteration, Backlog
