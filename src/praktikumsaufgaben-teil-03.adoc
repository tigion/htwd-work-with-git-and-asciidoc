...
Eine weitere Möglichkeiten für die Zusammenarbeit über GitHub sind *Pull requests*, welche wir uns im nächsten Semester (<<praktikumsaufgaben-teil-09.adoc#, Teil 8 - Zusammenarbeit 3>>) anschauen.
