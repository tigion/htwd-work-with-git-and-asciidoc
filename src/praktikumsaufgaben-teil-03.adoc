...
Eine weitere Möglichkeiten für die Zusammenarbeit über GitHub sind *Pull requests*, welche wir uns im nächsten Semester (<<praktikumsaufgaben-teil-09.adoc#, Teil 9 - Zusammenarbeit 4>>) anschauen.
