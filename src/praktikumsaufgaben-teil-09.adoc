...
* Hinweise zur Einrichtung und Verwendung von PlantUML in Asciidoctor und Visual Studio Code finden Sie unter <<praktikumsaufgaben-teil-05.adoc#c4-model-diagrams, Praktikumsaufgaben Teil 5 - Diagramme 1>> vom letzten Semester.
====
...
Für die Verwendung und Hinweise von C4-Modell Diagrammen siehe: <<praktikumsaufgaben-teil-05.adoc#c4-model-diagrams, Teil 5 - Diagramme 1 - C4 Model Diagramme>>.
...
Für die Verwendung und Hinweise von C4-Modell Diagrammen siehe: <<praktikumsaufgaben-teil-05.adoc#, Teil 5 - Diagramme 1 - C4 Model Diagramme>>.
...
class2 --> actor1: Send
----
<1> Beziehungen zwischen Teilnehmern werden mit `+->+` (durchgezogen) oder `+-->+` (gestrichelt) angegeben. Die verschiedenen Pfeilarten entnehmene Sie bitte der offiziellen Dokumentation unter https://plantuml.com/de/sequence-diagram#efeda651e89e596c[Pfeilarten].
...
<2> Verhindert schräge Linien, um eine unschöne Darstellungen der Krähenfußnotation zu unterbinden.
=====
====
...
:diagramTitle: Entity Relationship Diagramm mit PlantUML (Chen-Notation)
