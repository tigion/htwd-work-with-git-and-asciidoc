...
<4> Zusätzliche Angabe eines alternativen Verweisnamens
...
. Lagern Sie den Quelltext aus <<Aufgabe 1.3 - Quellcode>> in eine extra _hello_world.c_ Datei aus.
...
include::path/to/hello-world.c[lines=3..7] <2>
----
...
. Clonen Sie Ihr Repository *htw-se-example-project*:
+
----
$ git clone https://github.com/<username>/htw-se-example-project.git
----

. Wechseln Sie in das eben erstellte Verzeichnis *htw-se-example-project*:
+
----
$ cd htw-se-example-project
----
...
. Navigieren Sie zu Ihrem Projektverzeichnis *htw-se-example-project*:
+
----
$ cd path/to/se1-praktikum/htw-se-example-project
----
