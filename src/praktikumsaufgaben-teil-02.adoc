...
[NOTE]
====
Fügen Sie im Dokumenten-Kopf das Attribut `:source-highlighter: highlight.js` hinzu, um in der Vorschau und beim Generieren Quellcode mit Syntax-Highlighting zu erhalten.

(Bei Verwendung der lokal instalierten Tools: `:source-highlighter: rouge`.)
====
