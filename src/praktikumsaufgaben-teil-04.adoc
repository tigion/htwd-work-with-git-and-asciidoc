...
Die Bearbeitung der Aufgabe 1 und zum Teil in Aufgabe 2 erfolgt in Ihrem Teamrepository *htw-se-example-teamproject* aus dem letzten Praktikum. In Aufgabe 3 nehmen Sie Ihr Repository *htw-se-example-project*.
...
GitHub bietet mit dem Bereich *Issues* eine Möglichkeit anstehende Aufgaben, aufgetretene Probleme und mögliche Verbesserungen zentral in Ihrem Projekt innerhalt Ihres Repository zu verwalten und zu diskutieren.
...
** *Zeit* und *Resourcen* spielen ebenfalls eine Rolle, ob die Zuteilung der Work Items auf die aktuelle bzw. folgenden Iterationen erfolgt.
...
:imageTitle: Detailansicht eines Meilensteines
...
. Schließen Sie eine Work Item (Issue) und schauen Sie sich die Änderung im *Iterations*-Projekt und dem *Phasen*-Meilenstein an.
