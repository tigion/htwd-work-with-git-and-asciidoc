...
. Erstellen Sie auf *GitHub* einen *Fork* des Vorführprojekts https://github.com/tigion/htw-se-practical-asciidoc-diagram-demo[htw-se-practical-asciidoc-diagram-demo] und *clonen* Ihr Repository in das Verzeichnis, in dem ihre Repositories aus dem Praktikum liegen.
...
** Es sollten jetzt ein Testdiagramme und ein Infodiagramm wie in der https://github.com/tigion/htw-se-practical-asciidoc-diagram-demo/blob/main/README.md[README.md] des Vorführprojekts angezeigt werden.
