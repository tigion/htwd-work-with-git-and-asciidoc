...
. Erstellen Sie auf *GitHub* einen *Fork* des Vorführprojekts https://github.com/tigion/htwd-se-practical-asciidoc-diagram-demo[htwd-se-practical-asciidoc-diagram-demo] und *clonen* Ihr Repository in das Verzeichnis, in dem ihre Repositories aus dem Praktikum liegen.
