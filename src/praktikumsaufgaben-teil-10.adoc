...
. Erstellen Sie sich vom Repository https://github.com/tigion/htwd-se-practical-github-actions-exercise[htwd-se-practical-github-actions-exercise] einen Fork in Ihren GitHub Account und clonen ihn anschließend lokal auf Ihren Rechner.
