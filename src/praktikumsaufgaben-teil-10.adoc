...
* Hinweise zur Einrichtung und Verwendung von PlantUML in Asciidoctor und Visual Studio Code finden Sie unter <<praktikumsaufgaben-teil-06.adoc#c4-model-diagrams, Praktikumsaufgaben Teil 6 - Diagramme 1>> vom letzten Semester.
====
